...
# Need FastAPI backend and some type of friendly user facing front-end -- I am not familair with frontend development at all, I only know basic jacascript, html, and css.
